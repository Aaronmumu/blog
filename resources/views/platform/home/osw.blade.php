...
@section('body')
    <div class="banner-int gef-banner">
        ...
        <div class="banner-bg"><img src="/platform/img/sub_banner0.jpg" alt=""></div>
    </div>
    <div class="wrapper">
        <div class="layerbody">
            <div class="capacity">
        ...
        <div class="layerbody">
            ...
            <div class="mapworld map-hm">
                ...
                <img class="mapimg" src="/platform/img/mapworld.jpg" alt="" />
            </div>
        </div>
        <div class="layerbody">
            <div class="ykTitle"><h2>海外仓实景</h2></div>
            <ul class="live-action">
                <li><img src="/platform/img/live1.jpg" alt="" /></li>
                <li><img src="/platform/img/live2.jpg" alt="" /></li>
                <li><img src="/platform/img/live3.jpg" alt="" /></li>
            </ul>
        </div>
    </div>
