...
@section('body')
    ...
    <div class="wrapper">
        <div class="introPro">
            ...
            <div class="ItemPro">
                <div class="getload"><img src="/aaron/img/gc.jpg" alt="" /></div>
                <div class="getload">
            ...
            <div class="ItemPro ip2">
                ...
                <div class="getload"><img src="/aaron/img/ed.jpg" alt="" /></div>
            </div>
        </div>
    </div>
    <div class="whatwedo">
    ...
    <div class="wrapper">
        <div class="trait_service">
            ...
            <ul class="traitItems">
                <li>
                    <div class="icon"><img src="/aaron/img/ico2.png" alt="" /></div>
