...
<body>
    <div class="fixedHead header">
        <div class="wrapper">
            <div class="logo"><h1><a href="<?php echo url('/');?>"><img src="/aaron/img/logo.png" alt="" /></a></h1></div>
            <div class="nav">
                <ul>
                    ...
                    <li data-index="aaron"><a class="ons" target="_blank" href="http://oms.goodcang.com/default/open">开放平台</a></li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="footer">
        <div class="wrapper">
            <div class="footMenu">
                ...
                <div class="btmWachat">
                    <ul>
                        <li><img src="/aaron/img/eq1.jpg " alt="" /><p>微信公众号</p></li>
                        <li><img src="/aaron/img/eq2.jpg " alt="" /><p>新浪微博</p></li>
                    </ul>
                </div>
            </div>
