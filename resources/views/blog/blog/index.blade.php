            ...
            <div class="layui-tab-content">
                    ...
                    <div class="content-list">
                        <table class="layui-table">
                            ...
                            <tr>
                                ...
                                <td>
                                    <button class="layui-btn layui-btn-sm" onclick="COMMON.edit('<?php echo $item['b_id'];?>', '<?php echo route('getBlogJson', ['id' => $item['b_id']]);?>')">编辑</button>
                                    <button class="layui-btn layui-btn-sm" onclick="COMMON.del('<?php echo $item['b_id'];?>', '<?php echo route('delBlog', ['id' => $item['b_id']]);?>')">删除</button>
                                </td>
                            </tr>
                            <?php }?>
                            </tbody>
                ...
                <div class="layui-tab-item">
                    <form class="layui-form" action="">
                        ...
                        <input type="hidden" data-keyid="keyid" name="b_id" value="">
                        <div class="layui-form-item">
                            <label class="layui-form-label">标题</label>
                            <div class="layui-input-block">
                                <input type="text" name="title" required lay-verify="required" placeholder="请输入标题" value="null"
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="type" required lay-verify="required" placeholder="请输入类型" value="null"
                                       autocomplete="off" class="layui-input">
                            </div>
                        </div>
                        <div class="r1">
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" name="cover" required lay-verify="required" placeholder="请上传图片" value="null" autocomplete="off" class="layui-input pic-input">
                                </div>
                            </div>
                        </div>
        ...
        <script>
            ...
            layui.use('form', function () {
                ...
                form.on('submit(formDemo)', function (data) {
                    ...
                    json.content = text;
                    COMMON.add("<?php echo url('/blogs/addBlog');?>", json);
                    return false;
                });
            });
        </script>
