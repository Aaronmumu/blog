...
<head>
    ...
    <script type="text/javascript" src="/easyto/js/jquery-1.11.3.min.js"></script>
    <script type="text/javascript" src="/easyto/layui/layui.js"></script>
    <script type="text/javascript" src="/easyto/js/common.js"></script>
    <script type="text/javascript" src="/easyto/ckeditor/ckeditor.js"></script>
</head>
<body>
<style type="text/css">
            ...
            <section class="sidebar" style="height: auto;">
                ...
                <ul class="sidebar-menu tree" data-widget="tree">
                    ...
                    <li data-index="Dashboard">
                        <a href="<?php echo url('/easytos');?>">
                            <i class="fa fa-dashboard"></i>
                            <span>Dashboard</span>
                        </a>
                    </li>
                    <li data-index="branner">
                        <a href="<?php echo url('/easytos/pic');?>">
                            <i class="fa fa-dashboard"></i>
                            <span>轮播图</span>
                        </a>
                    </li>
                    <li data-index="news">
                        <a href="<?php echo url('/easytos/news');?>">
                            <i class="fa fa-dashboard"></i>
                            <span>新闻资讯</span>
                        </a>
                    </li>
                    <li data-index="faq">
                        <a href="<?php echo url('/easytos/faq');?>">
                            <i class="fa fa-dashboard"></i>
                            <span>常见问题</span>
                        </a>
                    </li>
                    <li data-index="job">
                        <a href="<?php echo url('/easytos/join');?>">
                            <i class="fa fa-dashboard"></i>
                            <span>招聘信息</span>
                        </a>
                    </li>
                    <li data-index="about">
                        <a href="<?php echo url('/easytos/about');?>">
                            <i class="fa fa-dashboard"></i>
                            <span>关于我们</span>
                        </a>
                    </li>
